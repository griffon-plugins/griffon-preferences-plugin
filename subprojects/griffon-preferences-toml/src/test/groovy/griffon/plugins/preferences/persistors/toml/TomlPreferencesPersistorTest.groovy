 ...
 */
package griffon.plugins.preferences.persistors.toml
...
class TomlPreferencesPersistorTest {
    static {
    ...
    void setup() {
        ...
        preferencesPersistor.content = '''|
            |[com.acme.SampleModel]
            |pstring = "string"
        |'''.stripMargin('|')
    ...
    void writeFromModelToPreferences() {
        ...
        // expect:
        def toml = new Toml().read(preferencesPersistor.content)
        assert 'STRING' == toml.com.acme.SampleModel.pstring
        assert !toml.com.acme.SampleModel.pboolean
        assert '12/12/2012' == toml.com.acme.SampleModel.pdate
    }
    ...
    private static class InMemoryPreferencesPersistor extends TomlPreferencesPersistor {
        String content = ''
